...
#define MAX_APPLICATION_SPEED_RPM       3150 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT         2267
#define PID_TORQUE_KI_DEFAULT         2267
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2267
#define PID_FLUX_KI_DEFAULT           2267
...
#define PID_SPEED_KP_DEFAULT          3366/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          116/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PHASE3_FINAL_SPEED_UNIT         (0*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT           19786
/* Phase 4 */
#define PHASE4_DURATION                1656 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (828*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT           19786
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (828*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT           19786

#define ENABLE_SL_ALGO_FROM_PHASE      1
/* Sensor-less rev-up sequence */
#define STARTING_ANGLE_DEG             0  /*!< degrees [0...359] */
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM          745
