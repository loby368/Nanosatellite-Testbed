...
#define RS                     1.09 /* Stator resistance , ohm*/
#define LS                     0.000146 /* Stator inductance, H
...
#define NOMINAL_CURRENT         19786
#define MOTOR_MAX_SPEED_RPM     3150 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  3.8 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -19786 /*!< Demagnetization current */
