...
int main(void) {
	...
	void Arduino_Debug() {
		int Euler_Heading_Int_x1000 = (int) ((Euler_Heading_Rad
				- Initial_Euler_Heading_Rad) * 1000); //Scale by 1000 to preserve 3 decimal places
		...
		Euler_Heading_Int_x1000_bytes[1] = (Euler_Heading_Int_x1000 >> 8)
				& 0xFF;  //
		Euler_Heading_Int_x1000_bytes[2] = (Euler_Heading_Int_x1000 >> 16)
				& 0xFF; //
		Euler_Heading_Int_x1000_bytes[3] = (Euler_Heading_Int_x1000 >> 24)
				& 0xFF; //msb

		uint8_t TxBuffer_Serial_Debug[16] =
				{ IMU, LC1_x1000, LC2x1000, RW_Speed }; // 16 bytes holding 4 uint32_t
		HAL_UART_Transmit(&huart1, Euler_Heading_Int_x1000_bytes, 4, 10); // Sending in normal mode

		printf("\nBytes %d %d %d %d\n", Euler_Heading_Int_x1000_bytes[0],
				Euler_Heading_Int_x1000_bytes[1],
				Euler_Heading_Int_x1000_bytes[2],
				Euler_Heading_Int_x1000_bytes[3]);
